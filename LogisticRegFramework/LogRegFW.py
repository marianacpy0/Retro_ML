...
while ans:
    ...
    if ans=="1":
        ...
        print("Predictions for Iris data set: ", predicted1)
    elif ans=="3":
        ...
        print("Expected value: ", exp.iloc[57])
        print("Expected value: ", exp.iloc[23])
        print("Expected value: ", exp.iloc[100])
